...
setwd(".")
mydata_hist <- read.csv("fitness_distances.csv", header = TRUE)
...
scale_fill_grey(start = .04) +
  ylab("alpha") +
  scale_x_continuous(breaks = (breaks=seq(0, 10000, by = 10)),limits=c(0, 130)) +
  scale_y_continuous(breaks = (breaks=seq(0, 5, by = 0.1)),limits=c(0, .5)) +
  theme_gray() +
...
scale_fill_grey(start = .04) +
  ...
  scale_x_continuous(breaks = (breaks=seq(0, 10000, by = 10)),limits=c(0, 130)) +
  scale_y_continuous(breaks = (breaks=seq(0, 2, by = 0.05)),limits=c(0, 0.499)) +
  theme_gray() +
...
scale_fill_grey(start = .04) +
  ylab("Distance") +
  scale_x_continuous(breaks = (breaks=seq(0, 10000, by = 100)),limits=c(0, 2880)) +
