...
scale_fill_grey(start = .04) +
  ylab("alpha") +
  scale_x_continuous(breaks = (breaks=seq(0, 10000, by = 500)),limits=c(0, 8000)) +
...
# beta points
alpha_graph <- ggplot2::ggplot(df, aes(x = n)) +
  geom_point(aes(x = n, y = beta1, fill = 'beta1', colour = 'beta1'), data = df, size = .8, shape = 18) +
  geom_point(aes(x = n, y = beta2, fill = 'beta2', colour = 'beta2'), data = df, size = .3, shape = 17) +
  geom_point(aes(x = n, y = beta0, fill = 'beta0', colour = 'beta0'), data = df, size = .6, shape = 16) +
scale_fill_grey(start = .04) +
  ylab("beta") +
  scale_x_continuous(breaks = (breaks=seq(0, 10000, by = 500)),limits=c(0, 8000)) +
  scale_y_continuous(breaks = (breaks=seq(0, 100, by = 0.5)),limits=c(0, 7)) +
  theme_gray() +
...
scale_fill_grey(start = .04) +
  scale_x_continuous(breaks = (breaks=seq(0, 10000, by = 500)),limits=c(0, 8000)) +
  scale_y_continuous(breaks = (breaks=seq(0, 1000, by = 10)),limits=c(550, 830)) +
  theme_gray() +
