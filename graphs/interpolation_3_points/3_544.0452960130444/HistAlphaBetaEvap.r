...
dist_hist <- ggplot2::ggplot(df, aes(x = distance)) +
  ...
  scale_x_continuous(breaks = (seq(0, 2000, by = 10)), limits=c(540, 730)) +
...
scale_fill_grey(start = .04) +
  ...
  scale_y_continuous(breaks = (breaks=seq(0, 5, by = 0.5)),limits=c(0, 3)) +
  theme_gray() +
...
scale_fill_grey(start = .04) +
  ylab("beta") +
  scale_x_continuous(breaks = (breaks=seq(0, 5000, by = 500)),limits=c(0, 3700)) +
  scale_y_continuous(breaks = (breaks=seq(0, 100, by = 0.5)),limits=c(0, 11.999)) +
  theme_gray() +
